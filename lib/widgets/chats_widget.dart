...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  List<Message> mList = [
    Message("Hi!. I need a help from you regarding last lecture.", 1, "08:47 pm", false),
    Message("Hey, sure. I have the notes. how can i help you?", 0, "08:52 pm", true),
    Message("I didn't understand the Knapsack algorithm", 1, "08:55 pm", true),
    Message("Can you help me to understand the simulation?", 1, "08:56 pm", true),
    Message("It's not that complicated. You can call me and I can show you that.", 0, "09:25 pm", true),
    Message("Alright, calling you rn.", 1, "09:30 pm", true),
    Message("In a Call", 2, "09:30 pm", true),
    Message("Thank you so much for helping. ", 1, "10:47 pm", true),
    Message("Mention not. Will you attend tomorrow's lecture?.", 0, "10:50 pm", true),
    Message("Yes!", 1, "11:01 pm", true),
    Message("Aren't you coming???", 1, "11:02 pm", true),
    Message("No, I have an important meeting that time. Can you please take the notes for me.", 0, "11:58 pm", true),
    Message("Alright I'll do that. ", 1, "08:47 pm", true),
    Message("Thanks a lot. ", 0, "12:30 am", true),
